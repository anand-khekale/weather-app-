...
request({ url, json: true}, (error, { body })=>{
    ...
    if (error) {
        ...
        data = `Currently ${body.current.weather_descriptions[0]}. Temperature is ${body.current.temperature} °C and it feels like ${body.current.feelslike} °C. This is for ${body.location.name}, ${body.location.country}, ${body.location.region}.`
    )
  })
}
